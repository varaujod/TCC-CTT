...
if (isset($requerimento)) {
    ...
    $fkempresa=$requerimento=["fkempresa"];
...
<link rel="stylesheet" href="/assets/css/admin/requerimentos.css">
<body>
    <main>
        <div class="container">
            <br><br>
            ...
            <?php endif; ?>
            <div class="titulo">
            <h1>Documentos Solicitados</h1> <img class="icon-titulo"src="/img/bell-fill.svg" >
            </div>
                ...
                <tbody>
                    <?php foreach ($requerimentos as $requerimento) : ?>
                        <tr>
                            ...
                            <td><?= esc($requerimento["nome"])?></td>
                            <td><?= esc($requerimento["assunto"]) ?></td>
                            <td><?= esc($requerimento["datafinal"]) ?></td>
                            <td class="enviar"><?= anchor(base_url("/admin/consultar/cadastro/requerimentos/" .$requerimento['codrequerimento']), 'Enviar <img class="icon-enviar"src="/img/send.svg">') ?></td>
                        </tr>
        </div>
    <?php endforeach; ?>
